...
foreach VAR (SE_codereview SE_datascience SE_emacs SE_opendata SE_programmers SE_softwarerecs SE_unix SE_webapps SE_webmasters SE_windowsphone SE_wordpress)
  bsub -W 3600 -n 8 -o ./out/$VAR.out.%J -e ./err/$VAR.err.%J mpiexec -n 16 /share3/wfu/miniconda/bin/python2.7 textMining.py run /share3/wfu/Datasets/StackExchange/$VAR.txt 16
end